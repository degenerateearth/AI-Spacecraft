...
- [`phase1_closure/`](phase1_closure/) is the current consolidated review package. It expands the operating proposal to 52 flight, ground and support records, records actively checked alternatives, defines 25 custom work packages and performs a build-and-operate omission audit. It does not close G1.
