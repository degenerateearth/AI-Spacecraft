...
| G1 | **First engineering gate — Phase 1 component evidence closure** | Exact documented component or released custom design for every F01–F16 function; all mission-relevant properties and interfaces closed under D1-CMP-STD-001 | **In progress — 52-record closure register; 5 bounded ground components supported, 25 custom work packages defined, 22 evidence exceptions; no flight component or custom design admitted** |
...
| M2 | Architecture and component baseline | Exact verifiable BOM, released custom designs, interface closure, mass/power/data/link budgets with margin, and decision record | BIRDS-derived open architecture selected for development; detailed Degen-1 boards/BOM/interfaces remain in progress under G1 |
